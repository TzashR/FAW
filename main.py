...
def main():
    ...
    ds, all_batches = make_ds_and_batches(args.reports_file, args.images_table_file, args.images_root_directory, 'train',
    ...
    ## train the model
    train_epochs(model=model, train_dl=train_dl, num_epochs=args.epochs, train_until_index=train_until_index,
                 batch_size=args.batch_size, with_pbar=args.with_pbar, print_loss=args.print_loss, is_gpu=args.is_gpu)
